...
- **Main Contributions**:
  - **Knowledge Base Construction**:
    - Participated in administrative data cleaning and structured processing
  - **LLM Testing and Optimization**:
    - Conducted large-scale answer quality testing, collected and analyzed model responses to 20000+ real administrative queries