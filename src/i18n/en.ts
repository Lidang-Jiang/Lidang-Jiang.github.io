export default {
  ...
  publications: {
    title: 'Publications',
    subtitle: 'My research papers published in peer-reviewed journals',
    impactFactor: 'IF',
  ...
  projects: {
    title: 'Projects',
    subtitle: 'A selection of my professional and personal projects',
  ...
  footer: {
    copyright: '© {year} Lidang Jiang. All rights reserved.',
    builtWith: 'Built with Vue 3 + Tailwind CSS',
  },
  theme: {
    light: 'Light Mode',
    dark: 'Dark Mode',
